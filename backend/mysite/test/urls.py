...
from external_api.views import AnimeChangePage, AnimeDetails, BookDetails, IGDBApiCallGamesDetails, IGDBApiCallGamesList, SearchAnime, SearchBooksList, TMDBApiCallMovieDetails, TMDBApiCallMoviesList, TMDBApiCallSerieDetails, TMDBApiCallSeriesList
