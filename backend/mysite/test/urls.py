...
from external_api.views import AnimeChangePage, BookDetails, IGDBApiCallGamesDetails, IGDBApiCallGamesList, SearchAnime, SearchBooksList, TMDBApiCallMovieDetails, TMDBApiCallMoviesList, TMDBApiCallSerieDetails, TMDBApiCallSeriesList
...
urlpatterns = [
    ...
    path('book/search/change_page',AnimeChangePage, name = 'search-anime-pagination'),
